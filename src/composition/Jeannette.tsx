...
export const JeannetteComposition: React.FC<AudiogramCompositionSchemaType> = ({
	subtitlesFileName,
	audioFileName,
	subtitlesTextColor,
		...
		<div ref={ref}>
			...
			<AbsoluteFill>
				<Sequence from={-audioOffsetInFrames} >
                    ...
                    <Img src={staticFile("images/2011_1.jpeg")} />
					<div
						className="container"
						style={{
							fontFamily: 'boldfont',
				...
				<Sequence  durationInFrames={500}   from={1000}> 
                        <FourFaces image={staticFile("images/2013_1.jpeg")}></FourFaces>
                    <Img src={staticFile("images/2013_1.jpeg")} />
					<div
						className="container"
						style={{
							fontFamily: 'boldfont',
